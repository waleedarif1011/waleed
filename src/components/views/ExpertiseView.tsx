...
const expertiseData = [
  {
    icon: <FaBrain size={40} className="mx-auto text-[#4B44D8]" />,
  ...
  {
    icon: <FaCogs size={40} className="mx-auto text-[#4B44D8]" />,
  ...
  {
    icon: <FaChartBar size={40} className="mx-auto text-[#4B44D8]" />,
    title: 'Data Science',
  ...
  {
    icon: <FaCode size={40} className="mx-auto text-[#4B44D8]" />,
      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {expertiseData.map((item, index) => (
            <div key={index} className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-lg shadow-lg p-6 text-center transform transition-transform duration-300 hover:-translate-y-2 hover:shadow-2xl">
              <div className="mb-4">
                {item.icon}
              </div>
